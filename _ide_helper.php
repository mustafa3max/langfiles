...
')
     ...
     */ 
         ...
         * @return \Kudashevs\ShareButtons\ShareButtons 
         * @static 
         */ 
        public static function page($url, $title = '', $options = [])
        {
                        /** @var \Kudashevs\ShareButtons\ShareButtons $instance */
                        return $instance->page($url, $title, $options);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function currentPage($title = '', $options = [])
        {
                        /** @var \Kudashevs\ShareButtons\ShareButtons $instance */
                        return $instance->currentPage($title, $options);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function createForPage($url, $title = '', $options = [])
        {
                        /** @var \Kudashevs\ShareButtons\ShareButtons $instance */
                        return $instance->createForPage($url, $title, $options);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function createForCurrentPage($title = '', $options = [])
        {
                        /** @var \Kudashevs\ShareButtons\ShareButtons $instance */
                        return $instance->createForCurrentPage($title, $options);
        }
                    /**
         ...
         * @static 
         */ 
        public static function getShareButtons()
        {
                        /** @var \Kudashevs\ShareButtons\ShareButtons $instance */
                        return $instance->getShareButtons();
        }
                    /**
