<div>
    ...
    <x-policy route="{{ $route }}">
        ...
        <div dir="ltr" class="px-2">
            ...
            <p>At langfiles, accessible from <a href="https://langfiles.com/"
                    class="text-accent hover:underline">www.langfiles.com</a>,
            ...
            <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website
                with
                regards to the information that they shared and/or collect in langfiles. This policy is not
                applicable
                to any information collected offline or via channels other than this website.</p>

            <h2 class="py-3 text-2xl font-bold">Consent</h2>

            <p>By using our website, you hereby consent to our Privacy Policy and agree to its terms.</p>

            <h2 class="py-3 text-2xl font-bold">Information we collect</h2>
            ...
            <h2 class="py-3 text-2xl font-bold">How we use your information</h2>
            ...
            <h2 class="py-3 text-2xl font-bold">Log Files</h2>

            <p>langfiles follows a standard procedure of using log files. These files log visitors when they visit
            ...
            <h2 class="py-3 text-2xl font-bold">Cookies and Web Beacons</h2>

            <p>Like any other website, langfiles uses "cookies". These cookies are used to store information
                including
            ...
            <h2 class="py-3 text-2xl font-bold">Advertising Partners Privacy Policies</h2>
            ...
            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that
                are
                used in their respective advertisements and links that appear on langfiles, which are sent directly
                to
            ...
            <p>Note that langfiles has no access to or control over these cookies that are used by third-party
                advertisers.</p>

            <h2 class="py-3 text-2xl font-bold">Third Party Privacy Policies</h2>

            <p>langfiles's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you
                to
            ...
            <h2 class="py-3 text-2xl font-bold">CCPA Privacy Rights (Do Not Sell My Personal Information)</h2>
            ...
            <h2 class="py-3 text-2xl font-bold">GDPR Data Protection Rights</h2>
            ...
            <h2 class="py-3 text-2xl font-bold">Children's Information</h2>
            ...
            <p>langfiles does not knowingly collect any Personal Identifiable Information from children under the
                age of
            ...
            <h2 class="py-3 text-2xl font-bold">Changes to This Privacy Policy</h2>
