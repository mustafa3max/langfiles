<div id="bodyText">
    <x-editor.img src="{{ asset('assets/blog/images/adding_multiple_languages_to_the_website_using_laravel.png') }}"
    ...
    <p>الآن انسخ السطر الذي يحتوي على key و value الموضح في الشفرة اعلاه وكرره عدة مرات ويفضل ازالة المحتوى من المفتاح
        والقيمة واكتب المفتاح باللغة الانجليزية فقط ويجب ان يكون المفتاح نفسه في باقي الملفات من اللغات اخرى ثم اكتب
