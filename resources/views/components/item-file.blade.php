<div class="grid md:flex gap-2 bg-primary-light dark:bg-primary-dark rounded-lg p-2 grow" dir="ltr">
    ...
    <button class="hover:bg-accent rounded-lg w-12 h-12 flex justify-center items-center"
