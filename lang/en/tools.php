...
return [
    ...
    "desc_1" => "Langfiles Tools is a program designed to localization projects for most operating systems. It allows you to modify,
 add,
 and translate scripts to your project,
 whether youre using Laravel,
 Flutter,
 or other frameworks.",
    "title_1" => "Currently supported operating systems",
    "desc_2" => "Langfiles Tools currently only works on Linux. In the near future,
 Windows and Mac systems will be supported if sufficient support is available for the Langfiles website to localize websites,
 applications and games.",
    "title_2" => "Currently supported frameworks",
    "desc_3" => "Langfiles Tools only supports the Laravel framework. Soon,
 the rest of the frameworks and tools for developing websites,
 applications and games will be supported. Note that we are working hard to support all frameworks,
 but currently we are working on Flutter.",
    "pros_and_cons" => "Pros and cons of langfiles tools",
    "pros" => "pros",
    "cons" => "cons",
    "desc_pros_and_cons" => "Every program in the world is not without some negatives,
 and in this section we will explain to you some of the positives and negatives in the langfiles tools program.",
    ...
    "desc_download" => "Download the langfiles tools program is currently available for Linux operating systems only.Click on the following link to download the program,
 then unzip it and use it. Thats all.",
    ...
    "desc_info_about_program" => "In this section,
 information is provided about the programs,
 operating systems,
 the architecture on which it runs,
 the version number,
 and what is new in the version.",
    ...
    "desc_vedio" => "In this video,
 I present to you a simplified explanation of the langfiles tools program so that you can have a quick look at the program before downloading it.",
    "keys" => "keys",
    "values" => "values",
